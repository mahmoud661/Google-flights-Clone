...
export const PassengerSelect: React.FC<Props> = ({ passengers, darkMode, onUpdatePassenger }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          className={`absolute left-[-100%] top-full mt-2 w-[14rem] sm:w-96 sm:left-0 ${
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-3">
                <button
                  type="button"
                  onClick={() =>
                    onUpdatePassenger("adults", passengers.adults - 1)
                  }
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-3">
                <button
                  type="button"
                  onClick={() =>
                    onUpdatePassenger("children", passengers.children - 1)
                  }
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-3">
                <button
                  type="button"
                  onClick={() =>
                    onUpdatePassenger("infants", passengers.infants - 1)
                  }
